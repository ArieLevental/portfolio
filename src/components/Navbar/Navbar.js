        ...
        <div className="hamburger"><p>Menu</p><div></div></div>
          <div className="menu">
            <div>
              <div>
                <ul>
                  <li className="navItem about__me" onClick={navbarClicked}><a href="#about__me__p">About Me</a></li>
                  <li className="navItem my__projects" onClick={navbarClicked}><a href="#my__projects_p">Projects</a></li>
                  <li className="navItem contact__me" onClick={navbarClicked}><a href="#contact__me__p">Contact</a></li>
